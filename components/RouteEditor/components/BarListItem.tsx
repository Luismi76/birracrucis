            ...
            <div className="flex min-h-[140px]">
                ...
                <div className="w-12 flex flex-col border-l border-slate-100 bg-slate-50/50">
                    <button
                        onClick={onMoveUp}
                        disabled={isFirst}
                        className="flex-1 flex items-center justify-center text-slate-400 hover:text-amber-600 hover:bg-amber-50 disabled:opacity-20 disabled:hover:bg-transparent transition-colors active:bg-amber-100"
                        title="Mover arriba"
                    >
