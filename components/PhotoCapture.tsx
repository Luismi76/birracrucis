          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 px-6 rounded-xl font-bold hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg active:scale-95 w-full"
              >
              ...
              <button
                ...
                disabled={uploading}
                className="flex items-center justify-center gap-3 bg-purple-600 text-white py-4 px-6 rounded-xl font-bold hover:bg-purple-700 disabled:opacity-50 transition-all shadow-lg active:scale-95 w-full"
              >
                {uploading ? (
                  <>
                  ...
                  <>
                    ...
                    <span className="text-lg">Subir a Galería</span>
                  </>
                )}
              </button>
            </div>
